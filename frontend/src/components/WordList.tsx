  ...
  <div className="bg-white p-4 shadow-md text-black">
      <div className="flex justify-between items-center">
        <div className="flex w-full items-center pr-2">
          ...
          <div className=''><span className='italic font-thin'>{word?.variant_count}</span></div>
        </div>
        <button onClick={showVariants} className="bg-white text-primary hover:underline focus:outline-none"><FaChevronRight size={23} /></button>
      </div>
  </div>
);
}
